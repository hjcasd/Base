...
import com.hjc.module_senior.databinding.SeniorActivityViewPathBinding
 ...
 * @Description: 自定义View
 */
@Route(path = RoutePath.Senior.URL_VIEW_PATH)
class ViewPathActivity : BaseActivity<SeniorActivityViewPathBinding, CommonViewModel>() {

    override fun getLayoutId(): Int {
        return R.layout.senior_activity_view_path
    }
