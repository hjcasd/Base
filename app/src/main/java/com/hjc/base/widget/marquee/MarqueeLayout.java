...
public class MarqueeLayout extends ViewGroup {
    ...
    private int mSwitchTime;   //切换时间
    private int mScrollTime;   //滚动时间
    /**
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mOrientation == ORIENTATION_DOWN || mOrientation == ORIENTATION_UP) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                child.layout(paddingLeft + lp.leftMargin, (height - child.getMeasuredHeight()) / 2 + multiHeight, child.getMeasuredWidth
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                child.layout((width - child.getMeasuredWidth()) / 2 + multiWidth, paddingTop + lp.topMargin,
                        (width - child.getMeasuredWidth()) / 2 + child.getMeasuredWidth() + multiWidth, child.getMeasuredHeight() +
